                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" value="{{ $produk->deskripsi }}" autofocus placeholder="deskropsi ">
                            @error('deskripsi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
